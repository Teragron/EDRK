...
# Adaptive Ralston's fourth order method

def ARRK(tinc=0.01, tend=4000, alpha=0.05):
    ...
    for i in range(num_steps-1):
        ...
        phi_next = phi_values[i] + (k1[0] + 3*k2[0])/4 
        phi_dot_next = omega_values[i] + (k1[1] + w*k2[1])/4 
