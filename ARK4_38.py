# -*- coding: utf-8 -*-
"""
Created on Mon Mar 25 06:23:00 2024
...
def ARK4_38(tinc=0.01, tend=4000, alpha=0.05):
    ...
    for i in range(num_steps-1):
        ...
        phi_next = phi_values[i] + (k1[0] + 3*k2[0] + 3*k3[0] +  w*k4[0]) / 8
        phi_dot_next = omega_values[i] + (k1[1] + 3*k2[1] + 3*k3[1] + w*k4[1]) / 8
